    ...
    return (
        <>
            <div style={{ textAlign: 'center', margin:1 }}>
                <IconButton onClick={() => setColumns(2)} sx={{ color: 'black', margin: '0 1px' }}
                    ><GridViewIcon /></IconButton>
                <IconButton onClick={() => setColumns(3)} sx={{ color: 'black', margin: '0 1px' }}
                    ><GridOnIcon /></IconButton>
            </div>
            <div style={{ margin:'5px',fontSize: '15px', textAlign: 'center' }}>{props.title}</div>
            <div style={{
                display: 'grid',
                ...
                ))}
                {
                    visibleCount < bestTotalProducts && (
                        <div style={{ textAlign: 'center', margin: '1px 0' }}>
                            <Button onClick={loadMore} sx={{ }}>더보기</Button>
                        </div>
                    )
                }
            </div>
